""" autofalloff - demonstrate application framework with testing.
"""
...
class AutoFallOffApplication(object):
    """ Create the window with the graphs, setup communication based on
    the specified device.
    """
    def __init__(self):
        super(AutoFallOffApplication, self).__init__()
        log.debug("startup")
